...
% ====================
\begin{document}
\IfSubfilesClassLoaded{\chapter{SE Analysis \& Control: Work Breakdown Structure}}{}
...
\begin{description}
  ...
  \item[\textbf{Standards.}] MIL-STD-881F is the current active standard for preparing, understanding, and presenting \acp{wbs} for defense materiel items~\autocite{edo-3-5-2-wbs-2025,MILSTD-881F}.
  \item[\textbf{Types.}] Program \ac{wbs} is owned by the \ac{pmo}; contract \ac{wbs} extends the program structure to the level of detail needed for the agreement and negotiated reporting needs~\autocite{edo-3-5-2-wbs-2025,MILSTD-881F}.
\end{description}

\subsection{Introduction}
\begin{description}
  \item[\textbf{Purpose.}] The \ac{wbs} breaks large projects into manageable, product-oriented parts using a DoD-standard format~\autocite{edo-3-5-2-wbs-2025,MILSTD-881F}.
...
\begin{description}
  \item[\textbf{MIL-STD-881F.}] Provides the principal guidance and standardized formats for \ac{wbs} development across system types; ASSIST lists Revision~F as active, dated 13~May~2022~\autocite{edo-3-5-2-wbs-2025,MILSTD-881F}.
...
\begin{description}
  ...
  \item[\textbf{Structure.}] Extends the approved program \ac{wbs} to the level of detail needed for the contract, other agreement, and reporting requirements, including all applicable hardware, software, data, or services~\autocite{edo-3-5-2-wbs-2025,MILSTD-881F}.
...
\begin{itemize}
  ...
  \item MIL-STD-881F is the current active \ac{wbs} standard for defense materiel items~\autocite{MILSTD-881F}.
  \item Program \ac{wbs} normally gives the Government framework; contract \ac{wbs} extends it to the detail needed for contract execution and reporting~\autocite{edo-3-5-2-wbs-2025,MILSTD-881F}.
