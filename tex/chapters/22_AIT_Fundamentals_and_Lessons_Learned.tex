...
% =============================================================================
\begin{document}
\IfSubfilesClassLoaded{\chapter{AIT Fundamentals and Lessons Learned}}{}
...
\begin{description}
  ...
  \item[\textbf{Submarines and Nuclear Vessels.}] Treat submarine, certified-boundary, and nuclear-interface work as
        boundary-controlled until the governing technical authority says otherwise~\autocite{edo-4-1-5-waterfront-work-control-2025,NAVSEA-0924-062-0010,SS800-AG-MAN-010,S9002-AK-CCM-010-6010}:
    \begin{itemize}
