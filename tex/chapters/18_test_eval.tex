...
\begin{figure}[htbp]
  ...
  \end{tikzpicture}
  \caption[\ac{dod} \ac{te} organization]{\ac{dod} test and evaluation governance chain linking \ac{osd} oversight, Service Operational Test Agencies, warfare centers/ranges, and program-level test leadership.}
