...
\begin{figure}
  ...
  \caption[\ac{mca} \ac{te} Touchpoints]{Key \ac{mca} test and evaluation touchpoints that frame \ac{dt}, \ac{optest}, and certification decisions. \srcCite{edo-3-5-5-test-eval-part-i-2025}.}\label{fig:TE_MCA}
\end{figure}
...
\begin{description}
  \item[\textbf{10~U.S.C.~\S~139.}] Establishes the \ac{dote} as an independent advisor to \ac{secwar} and Congress; \ac{dote} approves operational test plans, monitors execution, and must issue a public report for covered programs~\autocite{USC-10-139}.
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
      ...
      org/.style={draw=AccentBlue, fill=AccentBlue!10, rounded corners=2pt, align=center, inner sep=6pt, minimum width=3.8cm, text width=3.8cm},
  ...
  \end{tikzpicture}
  \caption[\ac{dow} \ac{te} organization]{\ac{dow} test and evaluation governance chain linking \ac{osd} oversight, Service Operational Test Agencies, warfare centers/ranges, and program-level test leadership.}
