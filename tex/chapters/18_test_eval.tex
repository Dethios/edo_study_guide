...
\begin{figure}[htbp]
  ...
  \end{tikzpicture}
  \caption[DoW T\&E organization]{DoW test and evaluation governance chain linking OSD oversight, Service OTAs, warfare centers/ranges, and program-level test leadership.}
