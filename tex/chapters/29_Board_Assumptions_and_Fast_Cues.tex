...
\subsection{Summary}
\begin{itemize}
  \item This appendix is the board-speed crosswalk for unstable facts, recurring traps, and high-yield pivots. Treat it as a final rehearsal checklist, not as a replacement for the detailed chapter sources.
...
\begin{description}
  ...
  \item[\textbf{Innovation tools.}] Is this better suited for an \ac{ot} prototype/follow-on or an \ac{sbir}/\ac{sttr} Phase I/II/III award path with data rights and transition protection~\autocite{USC-4021-OTA,USC-4022-OTF,USC-638-SBIR,SBIR-Apply-2026}?
