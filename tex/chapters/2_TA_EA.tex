...
\begin{description}
  ...
  \item[\textbf{Senior Technical Authority (STA).}] Certifies sufficient risk mitigation and maturity for critical systems to proceed past Milestone B; Title 10 USC \S 8669b requires \ac{secnav} to establish an \ac{sta} for each naval vessel class; \acp{sta} are dual-hatted as \ac{cse} Deputy Warranting Officers~\autocite{edo-2-1-5-technical-authority-2025}.
\end{description}
...
\begin{description}
  ...
  \item[\textbf{Warrant holders.}] See \sec~\ref{sec:twhs}~\autocite{edo-2-1-5-technical-authority-2025}.
...
\begin{description}
  \item[\textbf{DFS.}] Use the \ac{dfs} process with the \ac{lta} and align to the \ac{csmp}~\autocite{edo-2-1-5-technical-authority-2025}.
