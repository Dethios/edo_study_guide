...
\begin{document}
\IfSubfilesClassLoaded{\chapter{Technical Authority and Engineering Agents}}{}
%====================
% Contents here
%====================
...
\begin{itemize}
  \item If asked why \ac{ta} exists, lead with safety, reliability, common standards, independent engineering judgment, and disciplined risk acceptance.
  \item Separate authorities cleanly: \ac{pa} owns cost, schedule, performance, contracting, and resourcing execution; \ac{ta} owns technical standards, certification, and technically acceptable risk.
  \item For waterfront disagreements, walk the issue from project team or \ac{wfcheng} to \ac{lta}, \ac{twh}, deputy warranting officer, SEA 05 chief engineer, and COMNAVSEA as the ultimate \ac{ta}.
  \item For a deviation from drawing, specification, or standard, say \ac{dfs}: document the departure, route it through the \ac{lta}/\ac{ta} chain, track it, and do not let schedule pressure become technical approval.
  \item A ship's \ac{co} keeps command authority underway, but that emergency command judgment does not replace the warranted technical-authority chain.
  \item Engineering agents execute delegated technical work for warrant holders and program/Fleet customers; \acp{isea} are the in-service life-cycle support arm.
\end{itemize}
