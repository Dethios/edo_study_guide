...
\noindent\textit{Current as of 2025-11-01. This appendix is a historical billet-density snapshot from the November~2025 main slate; use \App{\ref{app:edo-flags}} for the current flag roster.}
...
\begin{itemize}
  ...
  \item For current flag officers and grade counts, use \App{\ref{app:edo-flags}}.
