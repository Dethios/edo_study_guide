...
% =============================================================================
\begin{document}
\IfSubfilesClassLoaded{\chapter{Mentoring Tips}}{}
\section{Mentoring Tips}
\note{Flow cue: this chapter applies the \ac{ldf}; the framework itself is summarized later in \Sec{\ref{sec:leader-development-framework}}. For board answers, describe mentoring as one execution mechanism for EDO character, competence, and culture development.}
