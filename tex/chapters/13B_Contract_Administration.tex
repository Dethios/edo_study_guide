...
\begin{description}
  ...
  \item[\textbf{Disputes and termination.}] Use \ac{adr} and the disputes process, and apply termination for convenience, cause, or default based on commercial/noncommercial context~\autocite{edo-3-2-6-contract-administration-2025,FAR,FAR-49-402-3-Default-Procedure,FAR-52-212-4-Commercial-Terms}.
\end{description}
...
\begin{description}
  \item[\textbf{DCMA.}] Provides worldwide contract administration for non-shipbuilding contracts; functions include contract management, quality assurance, engineering/production oversight, property management, and program support~\autocite[\S~42.302]{FAR}~\autocite{edo-3-2-6-contract-administration-2025,DCMA-About-2026,FAR-42-302-Contract-Administration}.
...
\begin{description}
  ...
  \item[\textbf{Notices.}] Cure notices provide 10 days to remedy failures; show-cause notices apply when time is insufficient or cure fails; termination notices explain consequences~\autocite{edo-3-2-6-contract-administration-2025,FAR-49-402-3-Default-Procedure,FAR-49-607-Delinquency-Notices}.
\end{description}
