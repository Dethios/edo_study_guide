...
\begin{description}
  ...
  \item[\textbf{Disputes process.}] If unresolved at the contracting officer level, contractors may use the disputes process under the Contract Disputes Act~\autocite{FAR-33-202-Disputes,edo-3-2-6-contract-administration-2025}.
\end{description}
...
\begin{description}
  ...
  \item[\textbf{COTS.}] \ac{cots} items are sold in substantial quantities in the commercial marketplace and offered to the Government without modification~\autocite{FAR-2-101-Definitions,edo-3-2-6-contract-administration-2025}.
\end{description}
