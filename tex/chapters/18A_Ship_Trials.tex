...
\begin{description}
  \item[\textbf{Title 10.}] 10~U.S.C.~7304 directs \ac{secnav} to designate a board of officers to examine Navy vessels and report material condition to \ac{cno}~\autocite{edo-3-5-7-ship-trials-2025}.
  \item[\textbf{OPNAV policy.}] \ac{opnavinst}~4700.8 series governs trials, acceptance, commissioning, fitting out, and post-shakedown availability for ships under construction or conversion~\autocite{edo-3-5-7-ship-trials-2025}.
...
\begin{description}
  ...
  \item[\textbf{\ac{owld}.}] Obligations for construction and post-delivery work must occur before the \ac{owld}, typically 11 months after completion of fitting out~\autocite{edo-3-5-7-ship-trials-2025}.
...
\begin{description}
  \item[\textbf{\ac{bdt}.}] Pier-side tests to determine readiness to safely conduct sea trials and rehearse the \ac{at} schedule of events; presented by shipbuilder to \ac{supship}~\autocite{edo-3-5-7-ship-trials-2025}.
  \item[\textbf{\ac{bst}.}] Conducted after \ac{bdt} to demonstrate seaworthiness and readiness for \ac{at}; presented by shipbuilder to \ac{supship} with \ac{navsea} and ship's force observers~\autocite{edo-3-5-7-ship-trials-2025}.
  \item[\textbf{\ac{at}.}] Conducted after \ac{bst} to assess contract compliance and operational readiness; \ac{insurv} documents discrepancies and recommends acceptance or additional trials~\autocite{edo-3-5-7-ship-trials-2025}.
  \item[\textbf{\ac{iat}.}] Consolidates \ac{bst} and \ac{at} before delivery to accelerate schedules for mature production lines~\autocite{edo-3-5-7-ship-trials-2025}.
\end{description}
...
\begin{description}
  ...
  \item[\textbf{Purpose.}] Demonstrate the ability to fight the ship and satisfy Congressional \ac{lfte} requirements~\autocite{edo-3-5-7-ship-trials-2025}.
...
\begin{description}
  ...
  \item[\textbf{\ac{insurv} trials and delivery.}] \ac{insurv} conducts combined acceptance and final contract trials; delivery is followed by \ac{gmi}~\autocite{edo-3-5-7-ship-trials-2025}.
\end{description}
...
\begin{itemize}
  \item Ship trials are mandated by Title~10 and \ac{opnavinst} policy to certify readiness prior to delivery~\autocite{edo-3-5-7-ship-trials-2025}.
