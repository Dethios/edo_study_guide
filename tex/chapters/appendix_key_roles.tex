...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  ...
  \item[\textbf{Program Executive Offices (Navy portfolios).}]
        ...
        \begin{description}
          ...
          \item \textbf{PAE Mission Systems cue}: Remember the established PAE as mission-system integration across NAVWAR/NAVSEA/NAVAIR/Marine Corps Systems Command portfolios; do not use it to delete still-current PEO recall unless official pages have caught up.
        \end{description}
