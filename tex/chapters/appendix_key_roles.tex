...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  \item[\textbf{Department acquisition governance.}]
        ...
        \begin{itemize}
          ...
          \item Current as of 2026-05-27, Portfolio Acquisition Executive Mission Systems is a \ac{don} acquisition-governance overlay spanning PEO C4I, PEO Digital, PEO IWS, PEO MLB, DRPM Overmatch, DRPM LRNFO, DRPM MILE, Minotaur from PMA-290, and mission-system elements across NAVWAR, NAVSEA, NAVAIR, and Marine Corps Systems Command~\autocite{DON-PAE-Establishment-2026,DON-PAE-Mission-Systems-2026}.
  ...
  \item[\textbf{OPNAV corporate leadership.}]
        ...
        \begin{description}
          ...
          \item \textbf{\ac{opnav} resource integrators and sponsors (\ac{n8}, \ac{n82}, \ac{n9}, \ac{n9i}/9I):} Translate Fleet priorities into the \ac{pom}/\ac{fydp}, enforce two-pass/seven-gate rigor, and synchronize requirements, budgets, and \ac{peo} execution.
        \end{description}
  ...
  \item[\textbf{Program Executive Offices (Navy portfolios).}]
        ...
        \begin{description}
          ...
          \item \textbf{PAE Mission Systems cue}: Remember the overlay as mission-system integration across NAVWAR/NAVSEA/NAVAIR/Marine Corps Systems Command portfolios; do not use it to delete still-current PEO recall unless official pages have caught up.
        \end{description}
