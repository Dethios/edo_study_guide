...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  ...
  \item[\textbf{\ac{opnav} corporate leadership.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{\ac{opnav} resource integrators and sponsors (\ac{n8}, \ac{n82}, \ac{n9}, \ac{n9i}/N91):} Translate Fleet priorities into the \ac{pom}/\ac{fydp}, enforce two-pass/seven-gate rigor, and synchronize requirements, budgets, and \ac{peo} execution.
        \end{itemize}
  ...
  \item[\textbf{\ac{ppbe} resource sponsors.}]
        Sources: \ac{edo} Coursebook Module~3.1.1 (\ac{ppbe}, 2025 edition), NAVMAC Activity Manpower Management Guide Section~25, and current public \ac{opnavinst} readiness/assessment instructions.
        \begin{itemize}
          ...
          \item \textbf{\ac{n9i}/N91}: Cross-domain warfare integration; public manpower coding lists this function as 9I Warfare Integration.
