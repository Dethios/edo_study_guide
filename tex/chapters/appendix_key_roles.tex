...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  \item[Purpose.] This appendix is the role map for answering ``who owns what'' across requirements, acquisition, technical authority, contracting, test, finance, and modernization.
  \item[Authority split.] Keep \ac{pa}, \ac{ta}, and \ac{ko} authority separate: program leaders own outcomes, technical authorities own standards and risk acceptability, and warranted contracting officers bind the Government.
  \item[Governance flow.] Connect \ac{ccdr}/\ac{jroc}/\ac{opnav} demand signals to \ac{asnrdanda}, \acp{pae}/\acp{peo}, \acp{pm}, \acp{syscom}, and Fleet acceptance.
  \item[Board use.] Use this as a crosswalk when a scenario asks who approves, who funds, who signs, who certifies, who tests, or who accepts residual risk.
\end{description}
...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  ...
  \item[\textbf{Operational test oversight.}]
        Sources~\autocite{DoDI5000-85,DoDI5000-89,DoDI5000-98}.
        \begin{description}
  ...
  \item[\textbf{PPBE resource sponsors and integrators.}]
        ...
        \begin{description}
          \item \textbf{\ac{cape}}: Independent analytic staff supporting Program Review decisions and \ac{ice}/\ac{poe} for major programs~\autocite{USC-139a-CAPE,edo-3-1-1-ppbe-2025}.
...
\begin{itemize}
  \item Ask first: is the decision a requirement, funding, program, technical, contracting, test, cyber, or Fleet-risk decision?
  \item \ac{ccdr}/Fleet define operational need; \ac{opnav} sponsors and resources; \ac{asnrdanda}/\ac{mdauthority} approve acquisition decisions; \ac{pm} executes.
  \item \ac{ta} can disapprove unsafe or noncompliant technical departures even when a \ac{pm} has schedule pressure.
  \item \ac{ko} authority is separate from \ac{pm} authority; only the warranted \ac{ko} can bind the Government.
  \item Test and Fleet-release answers should name \ac{dote}/\ac{comoptevfor}, \ac{mdauthority}/\ac{peo}, and \ac{tycom} residual-risk roles.
\end{itemize}
%====================
% End of file
%====================
