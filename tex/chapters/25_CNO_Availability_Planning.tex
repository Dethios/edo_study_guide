...
% =============================================================================
\begin{document}
\IfSubfilesClassLoaded{\chapter{CNO Availability Planning}}{}
...
\begin{description}
  ...
  \item[\textbf{AWP sources.}] \ac{awp} work candidates come from \ac{cmp}/\ac{icmp}, \ac{navsea}-authorized alterations, \ac{tycom}-authorized alterations/repairs/PMRs/baseline \acp{awp}, pre-availability tests and inspections, \ac{csmp}, and Fleet Technical Support records~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item[\textbf{AWP timeline.}] Public \ac{jfmm} stages are Baseline, Preliminary, Proposed, Approved, and Completed; current public text supports a Preliminary \ac{awp} about 12--14 months before start, Proposed within two months after WDC/PRC, Approved at PAC, and Completed within six months after completion~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
...
\begin{itemize}
  \item \ac{cmp}/\ac{icmp} routine maintenance and inspections~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item \ac{navsea}-authorized alterations and \ac{tycom}-authorized alterations, repairs, PMRs, and baseline \acp{awp}~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item Pre-availability tests and inspections (\ac{tsra}, \ac{pots}/\ac{pats})~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item \ac{csmp} items and Fleet Technical Support records~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
\end{itemize}
...
\begin{description}
  \item[\textbf{Baseline AWP.}] Planning requirements from \ac{submepp} (submarines) or \ac{pms}~312C (aircraft carriers); the A-36 cue is retained as coursebook planning shorthand~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item[\textbf{Preliminary AWP.}] Consolidates baseline \ac{awp}, authorized alterations, and repairs; public \ac{jfmm} text places this about 12--14 months before start~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item[\textbf{Proposed AWP.}] Issued within two months after WDC/PRC; coursebook cues include \ac{tycom} review of pre-availability tests and inspections, \ac{ipm} for submarines, and A-12 carrier planning~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item[\textbf{Approved AWP.}] Approved at PAC; the A-3/post-final cue is coursebook shorthand for final planning updates~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item[\textbf{Completed AWP.}] Issued within six months of availability completion as requirements gain fidelity over time~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
\end{description}
...
\begin{description}
  \item[\textbf{Baseline planning owners.}] \ac{submepp} (submarines), \ac{pms}~312C (aircraft carriers), and \ac{surfmepp} (surface) maintain the baseline \ac{awp}~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
...
\begin{itemize}
  \item Core \ac{awp} source buckets: \ac{cmp}/\ac{icmp}, authorized alterations and repairs, pre-availability tests and inspections, \ac{csmp}, and Fleet Technical Support records~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
  \item Baseline \ac{awp} producers: \ac{submepp} (subs), \ac{pms}~312C (aircraft carriers), \ac{surfmepp} (surface)~\autocite{COMFLTFORCOMINST4790-3,edo-4-2-1-cno-availability-planning-2025}.
