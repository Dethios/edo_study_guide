...
\noindent\textit{Current as of 2026-05-09. This appendix uses the May~2026 public Navy flag roster as the primary source for current grades and billets. Navy public biography headings that state ``Rear Admiral'' are not sufficient to distinguish \acs{radm} from \acs{rdml}; command biographies are used only to explain live title conflicts.~\autocite{navy-flag-roster-2026-05,navy-jett-parmer-2025,ssp-richman-2026}}
...
\begin{longtblr}[
    ...
    colspec = {Q[l,wd=0.11\textwidth] Q[l,wd=0.22\textwidth] Q[l,wd=0.31\textwidth] Q[l,wd=0.28\textwidth]},
    rowhead = 1
  }
  \toprule
  ...
  RDML (RADM select) & Scott M.\ Brown & Director, Industrial Operations (NAVSEA 04) & Oversees naval shipyard and industrial operations that underpin fleet maintenance and industrial-base readiness. \\
...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  \item[\textbf{Roster interpretation notes.}] Scott Brown appears in the May~2026 roster as ``RADM(S)''; this appendix lists him as \acs{rdml} (RADM select) to reflect current grade plus pending promotion. Richman's official \ac{ssp} leadership page uses ``Deputy Director, Regional Strike Systems,'' while the May~2026 roster uses ``Deputy Director for Hypersonics.'' Jett-Parmer's official Navy bio still lists ``Deputy Commander, Supervisor of Shipbuilding, Conversion and Repair,'' while the May~2026 roster lists ``Reserve Deputy, Naval Sea Systems Command.'' This appendix follows the May~2026 roster for the displayed billet titles~\autocite{navy-flag-roster-2026-05,navy-jett-parmer-2025,ssp-richman-2026}.
\end{description}
%====================
% End of file
%====================
