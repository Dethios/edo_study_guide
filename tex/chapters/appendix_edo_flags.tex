...
\noindent\textit{Current as of 2026-05-27. This appendix uses the May~2026 public Navy flag roster as the primary source for current grades and billets. Navy public biography headings that state ``Rear Admiral'' are not sufficient to distinguish \acs{radm} from \acs{rdml}; command biographies are used only to explain live title conflicts.~\autocite{navy-flag-roster-2026-05,navy-jett-parmer-2025,ssp-richman-2026}}
