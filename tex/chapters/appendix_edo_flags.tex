...
\noindent\textit{Current as of 2026-04-09. This appendix uses the April~2026 public Navy flag roster as the primary source for current billets and uses command biographies only to explain live title conflicts.~\autocite{navy-flag-roster-2026-04,navy-jett-parmer-2025,ssp-richman-2026}}
...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  \item[\textbf{Roster interpretation notes.}] Scott Brown appears in the April~2026 roster as ``RADM(S)''; this appendix lists him as \acs{rdml} (RADM select) to reflect current grade plus pending promotion. Richman's official \ac{ssp} leadership page uses ``Deputy Director, Regional Strike Systems,'' while the April~2026 roster uses ``Deputy Director for Hypersonics.'' Jett-Parmer's official Navy bio still lists ``Deputy Commander, Supervisor of Shipbuilding, Conversion and Repair,'' while the April~2026 roster lists ``Reserve Deputy, Naval Sea Systems Command.'' This appendix follows the April~2026 roster for the displayed billet titles~\autocite{navy-flag-roster-2026-04,navy-jett-parmer-2025,ssp-richman-2026}.
\end{description}
%====================
% End of file
%====================
