...
\begin{longtblr}[
  ...
  {Action} & {Role} \\
  \midrule
  Decide which vendor will be awarded the contract & KO \\
...
\begin{description}
  ...
  \item[\textbf{Approval.}] Other-than-full-and-open competition requires an approved \ac{ja} or \ac{df} per \ac{far} Subpart~6.3; justifications must be posted to \url{https://sam.gov} after award~\autocite{edo-3-2-1-intro-contracting-2025}.
\end{description}
...
\begin{enumerate}
  ...
  \item Industrial mobilization or development of an essential capability.
