...
% =============================================================================
\begin{document}
\IfSubfilesClassLoaded{\chapter{Intro to Contracting Fundamentals}}{}
%====================
% Contents here
%====================
...
\begin{longtblr}[
  ...
  \bottomrule
\end{longtblr}
\note{The \ac{ko} awards and signs the contract. In formal source selections, the \ac{ssa} selects best value when appointed; under \ac{far}~15.303, the contracting officer may serve as the \ac{ssa} by default~\autocite{edo-3-2-1-intro-contracting-2025,FAR-15-303-Responsibilities}.}
