...
\begin{description}
  ...
  \item[\textbf{Execution focus.}] Execution emphasizes rapid, iterative design, development, testing, and delivery supported by a product roadmap and program backlog~\autocite{edo-3-4-2-software-acquisition-management-2025}.
  \item[\textbf{Support share.}] Post-deployment software support dominates total life-cycle cost and must be planned early~\autocite{edo-3-4-2-software-acquisition-management-2025}.
\end{description}
...
\begin{description}
  ...
  \item[\textbf{Artifacts before execution.}] Capability needs statement, user agreement, cost estimates and \ac{card}, acquisition strategy, test strategy, cybersecurity strategy, contracting strategy, intellectual property strategy, and program support strategy~\autocite{edo-3-4-2-software-acquisition-management-2025}.
\end{description}
...
\begin{description}
  \item[\textbf{Timing and updates.}] Estimates are required before execution and updated annually~\autocite{edo-3-4-2-software-acquisition-management-2025}.
...
\begin{description}
  \item[\textbf{Purpose.}] Rapidly and iteratively design, develop, integrate, test, deliver, and operate resilient software capabilities that meet user priorities~\autocite{edo-3-4-2-software-acquisition-management-2025}.
  \item[\textbf{Artifacts.}] Periodic updates to planning artifacts, systems architecture, product roadmap, program backlog, value assessment, Clinger-Cohen compliance, test plans, and program metrics~\autocite{edo-3-4-2-software-acquisition-management-2025}.
\end{description}
...
\begin{description}
  ...
  \item[\textbf{Software design.}] Build detailed designs for each \ac{si} and verify requirements are met (not applicable to Agile development)~\autocite{edo-3-4-2-software-acquisition-management-2025}.
...
\begin{description}
  ...
  \item[\textbf{Preferred approach.}] \ac{dod} prefers empirical (Agile) development because it supports continuous inspection and adaptation to emerging threats~\autocite{edo-3-4-2-software-acquisition-management-2025}.
\end{description}
...
\begin{description}
  ...
  \item[\textbf{Cost share.}] \ac{pdss} accounts for approximately 67 percent of total software life-cycle cost~\autocite{edo-3-4-2-software-acquisition-management-2025}.
\end{description}
...
\begin{itemize}
  ...
  \item \ac{pdss} is approximately 67 percent of total software life-cycle cost~\autocite{edo-3-4-2-software-acquisition-management-2025}.
\end{itemize}
