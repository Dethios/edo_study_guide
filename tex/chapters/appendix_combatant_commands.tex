...
\begin{itemize}
  ...
  \item \ac{usnorthcom}
  \item \ac{ussouthcom}
  \item \ac{usspacecom}\footnote{\ac{usspacecom} is treated by \ac{dow} as a \textbf{geographic (astrographic)} command with an \ac{aor} beginning at the K\'{a}rm\'{a}n line ($\sim$100\,km)}
\end{itemize}
\textbf{Functional (4):}
\begin{itemize}
  \item \ac{uscybercom}
