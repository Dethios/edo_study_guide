...
\begin{itemize}
  ...
  \item \ac{supship} can execute validation and surveillance responsibilities for shipbuilding programs on behalf of \ac{dcma}\FlagBilletNote{\ac{rdml} Jonathan J.\ Jett-Parmer leads \ac{supship}; \ac{rdml} Robert J.\ Dodson (\ac{usnr}) is the reserve deputy}.
\end{itemize}
