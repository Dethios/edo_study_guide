...
\textbf{Current as of 2026-03-25.}

\subsection{Executive Summary}
\begin{itemize}
  \item The Navy current \ac{pae} construct is not a 1:1 relabeling of \acp{syscom} or \acp{peo}; it is a portfolio-layer overlay that absorbs authority across both.
  \item The six \acp{pae} map roughly across warfare domains plus industrial base, cutting across traditional \ac{syscom} seams.
...
\textit{Assumption note: this appendix captures your provided construct as a working study aid and should be validated against any formal Navy implementation directives as they are published.}
