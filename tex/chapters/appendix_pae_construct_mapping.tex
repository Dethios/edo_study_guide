...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  \item[Authority conflicts.] Tension between \ac{syscom} technical authority and \ac{pae} decision authority may drive early-cycle delays.
  \item[Workforce realignment.] \acp{peo} may lose decision scope and senior billets, creating talent migration risk.
  \item[Contracting consolidation.] Transition from program contracts to portfolio contracts may disrupt prime and supply-chain behavior.
\end{description}
