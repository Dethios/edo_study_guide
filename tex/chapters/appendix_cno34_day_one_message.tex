...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  \item[Purpose.] This appendix preserves \ac{adm} Caudle's opening strategic message and follow-on C-Notes as a current-event reference for board answers.
  \item[Central frame.] The message uses Foundry--Fleet--Fight to connect force generation, deployed combat power, and future warfighting advantage.
  \item[Board use.] Use the summarized cues for oral answers, then return to the source text when you need exact wording from the NAVADMINs.
\end{description}

\subsection{Day-One Message Text}
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
...
\emph{\footnotesize NAVADMINs 186/25, 203/25, 241/25, and 225/25~\autocite{cno-cnote-1-2025,cno-cnote-2-2025,cno-cnote-3-2025,cno-charge-of-command-2025}. Current official CNO page checked 2026-06-05: later CNO34 products include C-Notes \#4--\#8 and U.S.\ Navy Fighting Instructions~\autocite{cno-cnotes-landing-2026,cno-cnote-4-2026,cno-cnote-5-2026,cno-cnote-6-2026,cno-cnote-7-2026,cno-cnote-8-2026,cno-fighting-instructions-2026}.}
...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  ...
  \item[Current series overlay.] The official CNO page now extends the initial three-note set with C-Note \#4, \emph{The Way We Fight}; C-Note \#5, \emph{The Backbone of the Fleet: Chief Petty Officers}; C-Note \#6, \emph{Excellence Ashore}; C-Note \#7, \emph{Golden Fleet Initiative and our Future Fleet Design}; C-Note \#8, \emph{Continuous Improvement as Warfighting Advantage}; and U.S.\ Navy Fighting Instructions as the broader organize--train--equip--fight framework~\autocite{cno-cnote-4-2026,cno-cnote-5-2026,cno-cnote-6-2026,cno-cnote-7-2026,cno-cnote-8-2026,cno-fighting-instructions-2026}.
...
\begin{itemize}
  \item Foundry = people, infrastructure, materiel, shipbuilding, repair, supply chains, training pipelines, and industrial capacity.
  \item Fleet = combat-credible people, platforms, and payloads that deter, assure allies, and project power.
  \item Fight = warfighting mindset, future fleet design, \ac{ai}, robotic/autonomous systems, resilient \ac{c2}, and synchronized effects.
  \item C-Note \#1 is Sailors First; C-Note \#2 is Foundry Always; C-Note \#3 is World Class Fleet; current official follow-ons through 2026-06-05 are C-Notes \#4--\#8 plus U.S.\ Navy Fighting Instructions.
  \item Charge of Command: command is action, accountability, disciplined risk, mission command, learning, and ownership of Sailors and readiness.
\end{itemize}
