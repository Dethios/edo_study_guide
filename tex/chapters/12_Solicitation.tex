...
\end{itemize}
\begin{description}
  \item[\textbf{FFP.}] Price not subject to adjustment; contractor assumes maximum risk and responsibility for costs and profit/loss~\autocite{edo-3-2-2-solicitation-prep-2025}.
  \item[\textbf{FPEPA.}] Price adjusted up or down based on specified contingencies (often economic indices)~\autocite{edo-3-2-2-solicitation-prep-2025}.
  \item[\textbf{FFP LOE.}] Fixed dollar amount for a specified level of effort over a stated period~\autocite{edo-3-2-2-solicitation-prep-2025}.
  \item[\textbf{FPIF.}] Final price equals final cost plus adjusted profit based on a shareline formula; profit varies with cost performance and is bounded by a ceiling price~\autocite{edo-3-2-2-solicitation-prep-2025}.
...
\end{itemize}
\begin{description}
  \item[\textbf{CPFF.}] Allowable costs plus a fixed fee; fee can change only if scope changes~\autocite{edo-3-2-2-solicitation-prep-2025}.
  \item[\textbf{CPIF.}] Allowable costs plus incentive fee tied to a formula based on total costs versus target costs; includes min and max fee~\autocite{edo-3-2-2-solicitation-prep-2025}.
  \item[\textbf{CPAF.}] Allowable costs plus base fee (possibly zero) and award fee~\autocite{edo-3-2-2-solicitation-prep-2025}.
...
\begin{description}
  \item[\textbf{T\&M.}] Used when the extent or duration of work cannot be estimated with reasonable confidence; based on direct labor hours plus materials at cost~\autocite{edo-3-2-2-solicitation-prep-2025}.
  \item[\textbf{LH.}] Similar to \ac{tnm}, but without material charges~\autocite{edo-3-2-2-solicitation-prep-2025}.
  \item[\textbf{Letter contract (UCA).}] Preliminary instrument authorizing immediate performance with a price ceiling when definitive contract negotiations cannot be completed in time~\autocite{edo-3-2-2-solicitation-prep-2025}.
\end{description}
...
\begin{itemize}
  ...
  \item Set-asides reserve acquisitions exclusively for small businesses and, using the Oct~1,~2025 inflation-adjusted thresholds, are automatic for actions above the \$15K micro-purchase threshold through the \$350K \ac{sat}; above the \ac{sat}, set-asides are used when two or more responsible small businesses are expected and fair market prices are likely~\autocite{edo-3-2-2-solicitation-prep-2025,AcquisitionGov-Threshold-Changes-2025}.
