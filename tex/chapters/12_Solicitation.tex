...
\begin{itemize}
  ...
  \item Solicitations and pre-solicitation opportunities are publicized on \url{https://sam.gov}; proposed actions over \$25K are synopsized in the \ac{gpe}, and actions over \$20K through \$25K require public display or appropriate electronic notice unless an exception applies~\autocite{edo-3-2-2-solicitation-prep-2025,FAR}.
\end{itemize}
