...
\begin{description}
  ...
  \item[\textbf{SSEB.}] Evaluates proposals against Section M criteria and rating standards, identifies strengths and weaknesses, documents deficiencies, and drafts discussion questions~\autocite{edo-3-2-3-source-selection-2025}.
\end{description}
