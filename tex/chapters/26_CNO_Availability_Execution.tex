...
% =============================================================================
\begin{document}
\IfSubfilesClassLoaded{\chapter{CNO Availability Execution}}{}
...
\begin{description}
  ...
  \item[\textbf{Open \& inspect.}] Conduct inspections onboard, inside shops, and on Ship's Force work items. Under the invoked Standard Item/FY package, \ac{navsea} Standard Item 009-001 can require reports that could change or add work by the first 20\% of the availability unless the Supervisor approves otherwise, and Standard Item 009-060 supports integrated production schedule planning of O\&I reports and review-impact analysis. Use inspection reports to authorize work, capture new and growth work, adjust anticipated repair quantities, and report schedule and cost impacts to financial customers (\ac{tycom}/fleet). Treat the A+60\% growth/new-work-on-contract rule as a coursebook or local planning cue unless the local contract invokes it~\autocite{NAVSEA-SSRAC-FY28,NAVSEA-STD-009-001-FY28,NAVSEA-STD-009-060-FY28,NAVSEA-STD-009-001-FY26,NAVSEA-STD-009-060-FY26,edo-4-2-2-cno-availability-execution-2025}.
  ...
  \item[\textbf{Testing, trials, \& certification.}] Enter the testing phase only after meeting the \ac{pcd}; for \ac{ait} work, production completion does not substitute for checkout, because completed/signed alteration completion records plus completed \ac{sovt} support final acceptance. Coordinate tests and trials with Ship's Force, the shipyard, and the customer so test scope aligns to the work performed and certification requirements~\autocite{edo-4-2-2-cno-availability-execution-2025,TS9090-310}.
\end{description}
...
\begin{description}
  ...
  \item[\textbf{CNO availability pairing.}] For \ac{cno} public shipyard availabilities, the public \ac{nsy} is both \ac{nsa} and \ac{lma}; for \ac{cno} private-sector availabilities, the \ac{rmc} or \ac{supship} is \ac{nsa} and the contractor is \ac{lma}~\autocite{edo-4-2-2-cno-availability-execution-2025}.
\end{description}
