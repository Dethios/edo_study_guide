...
\subsection{Summary}
\begin{description}
  \item[\textbf{KO accountability.}] The \ac{ko} must determine that every negotiated price is fair and reasonable, integrating price, cost, technical, field-pricing, and risk analysis inputs before award per \ac{far}~15.404-1(a)(1)--(5)~\autocite[\S~15.404-1(a)]{FAR}.
