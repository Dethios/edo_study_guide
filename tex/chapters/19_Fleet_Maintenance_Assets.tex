...
% =============================================================================
\begin{document}
\IfSubfilesClassLoaded{\chapter{Fleet Maintenance Assets}}{}
...
\begin{description}
  ...
  \item[\textbf{Locations and Specializations.}] The Navy operates four public Naval Shipyards that execute maintenance and modernization on submarines and aircraft carriers to return combat-ready ships to the Fleet~\autocite{NAVSEA-Shipyards-SIOP-2026}:
    \begin{itemize}
      ...
      \item \textbf{Norfolk Naval Shipyard (NNSY)} (Portsmouth, VA): Part of the four-yard public shipyard enterprise executing nuclear-powered aircraft carrier and submarine maintenance and modernization~\autocite{NAVSEA-Shipyards-SIOP-2026}.
      \item \textbf{Puget Sound Naval Shipyard \& IMF (PSNS \& IMF)} (Bremerton, WA): Provides maintenance, modernization, recycling, and support, with permanent sites in Bremerton, Bangor, Everett, San Diego, and Yokosuka; its history page identifies nuclear-powered-ship recycling, inactivation, and reactor-compartment disposal as a distinctive PSNS mission area~\autocite{NAVSEA-PSNS-IMF-Home-2026,NAVSEA-PSNS-IMF-History-2026}.
      \item \textbf{Pearl Harbor Naval Shipyard \& IMF (PHNSY \& IMF)} (Pearl Harbor, HI): Repairs, maintains, and modernizes fast-attack submarines and surface ships and is the most comprehensive fleet repair and maintenance facility between the U.S.\ West Coast and the Far East~\autocite{NAVSEA-PHNSY-IMF-Home-2026}.
    \end{itemize}
\end{description}
...
\begin{description}
  ...
  \item[\textbf{Locations.}] Commander, Navy Regional Maintenance Center (\ac{cnrmc}) oversees the Navy's listed regional maintenance center activities for surface-ship maintenance and modernization~\autocite{NAVSEA-CNRMC-About-2026}:
    \begin{itemize}
      ...
      \item \textbf{Ship Repair Facility Yokosuka, Japan} (SRF-JRMC).
    \end{itemize}
    CNRMC separately coordinates I-level maintenance activities at \textbf{RMC Northwest} embedded at PSNS \& IMF and \textbf{Hawaii RMC} embedded in PHNSY \& IMF~\autocite{NAVSEA-CNRMC-About-2026}.
  \item[\textbf{Cooperative Support.}] Public Naval Shipyards are government-owned and focused on submarine and aircraft-carrier maintenance and modernization. RMCs manage conventional surface ship maintenance and modernization, executing depot repairs primarily through private contractors while providing intermediate-level military repair capacity and fleet technical assistance~\autocite{NAVSEA-Shipyards-SIOP-2026,NAVSEA-CNRMC-About-2026}.
