...
\begin{description}
  ...
  \item[\textbf{Locations and Specializations.}] The Navy operates four public Naval Shipyards:
    \begin{itemize}
      \item \textbf{Portsmouth Naval Shipyard (PNSY)} (Kittery, ME): Specializes in nuclear-powered fast attack submarine (\ac{ssn}) maintenance, refueling, and modernization.
