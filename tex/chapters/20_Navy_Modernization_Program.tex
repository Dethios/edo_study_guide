...
% =============================================================================
\begin{document}
\IfSubfilesClassLoaded{\chapter{Navy Modernization Program}}{}
\section{Navy Modernization Program}

\subsection{Summary}
\begin{description}
  \item[\textbf{Purpose.}] \ac{nmp} manages ship modernization so alterations are properly engineered, approved, funded, and installed with configuration control and logistics support~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025}.
  ...
  \item[\textbf{Governance.}] \ac{nmp} provides the authoritative process and data environment for ship change approval, prioritization, and scheduling~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025}.
  \item[\textbf{Documentation.}] The Ship Change Document is the single authorized record for ship changes under the NDE entitled process~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025}.
  \item[\textbf{Policy.}] Current 10~U.S.C.~\S~2244a limits modifications for vessels or other equipment planned for retirement or disposal within five years after modification completion, with cost, reusable-item, safety, and national-security waiver exceptions~\autocite{USC-10-2244a,edo-4-1-2-navy-modernization-2025}.
\end{description}
...
\begin{description}
  \item[\textbf{Program goals.}] Maintain modernization policy and guidance, provide SME support, enable ship change review and approval, and ensure authoritative alteration scheduling~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
  \item[\textbf{Process discipline.}] \ac{nmp} structures identification, planning, design, approval, funding, and installation while maintaining configuration control and supportability~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025}.
  \item[\textbf{Risk control.}] Prevents unauthorized, non-supported ship changes and selects funded changes based on technical, readiness, and cost benefits~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
\end{description}
...
\begin{description}
  \item[\textbf{NDE-EP.}] The entitled process supports \ac{nmp} by collapsing alteration categories, providing a workflow, and enforcing hierarchical decision-making~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
  \item[\textbf{SCD purpose.}] The \ac{scd} replaces the Justification/Cost Form, SHIPALT Record, and \ac{ecp}; it is the single authorized document for ship changes in \ac{nde}~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025}.
  \item[\textbf{Authorization.}] An \ac{scd} becomes a ship change after procurement and installation authorization at Decision Point~3~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025}.
\end{description}

\subsection{SCD Initiation and Submission}
\begin{description}
  \item[\textbf{Initiators.}] Any user with an \ac{nde} account may initiate an idea, including program offices, port engineers, \acp{isea}, group staffs, \acp{tycom}, \acp{rmc}, and government planning yards~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
  \item[\textbf{Authorized submitters.}] Only authorized submitters can forward ideas for board review (about 130 submitters), designated across stakeholder organizations and trained in \ac{nmp}/SCD processes~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
\end{description}

\subsection{Approval Thresholds}
\begin{description}
  \item[\textbf{Program alterations.}] Approved based on \ac{acat} designation and monetary thresholds~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
  \item[\textbf{Fleet alterations.}] O-6 board approves changes under \$50M; 1--2 star board approves \$50M--\$200M; 3-star board sets priorities, approves Surface Ship Modernization Plan \ac{pom} submissions, and approves changes over \$200M~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
\end{description}

\subsection{NDE-NM Capabilities}
\begin{itemize}
  \item Tracks alteration development by category, ship class, and hull; planning and budgeting for programmed alterations; and estimated/actual man-days and costs~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
  \item Tracks logistics status, alteration maturity, Ship Installation Drawing status, execution schedules, and which ships have which alterations~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025}.
  \item Serves as the authoritative source for all \ac{cno} availability dates~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030}.
  \item Board tie-in: approved \ac{scd}/\ac{ndenm} data is what downstream \ac{rmmco}, \ac{ait}, \ac{isea}, and
        \ac{nsa} stakeholders use to confirm authorization, drawing maturity, logistics readiness, test procedures, and
        execution scheduling before shipboard installation~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025,TS9090-310}.
  \item Logistics tie-in: \ac{cdmdoa}/as-installed configuration updates, \ac{ils} certification, technical data, and
        training support are coordinated through NAVSEA logistics processes after the authorized change is planned and
        installed~\autocite{NAVSEA-Logistics-Planning-Processes-Policy-2026}.
\end{itemize}

\subsection{10 U.S.C. \texorpdfstring{\S}{Section} 2244a}
\begin{description}
  \item[\textbf{Restriction.}] Prohibits a military department from carrying out a modification of a vessel or other equipment item planned for retirement or disposal within five years after modification completion~\autocite{USC-10-2244a,edo-4-1-2-navy-modernization-2025}.
  \item[\textbf{Exceptions.}] The statute excludes below-threshold modifications, certain reusable-item transfers, and safety modifications; the Secretary concerned may waive the restriction when the modification is in the national security interest, with written notification to congressional defense committees~\autocite{USC-10-2244a,edo-4-1-2-navy-modernization-2025}.
\end{description}
...
\begin{itemize}
  ...
  \item The \ac{scd} replaces JCF, SHIPALT Record, and \ac{ecp} as the single authorized ship change document~\autocite{edo-4-1-2-navy-modernization-2025,SL720-AA-MAN-030,JFMM-VolVI-RevD-Chg5-2025}.
\end{itemize}
