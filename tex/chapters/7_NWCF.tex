...
\begin{description}
  ...
  \item[\textbf{\ac{ipr}.}] Used when requiring and performing activities are from different departments (outside \ac{dod}); cannot cite the \ac{po} statute but may cite \ac{wr} or other statutory authorities~\autocite{edo-3-1-5-field-activity-fm-2025}.
