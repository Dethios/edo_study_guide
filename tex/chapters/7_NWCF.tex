...
\begin{description}
  \item[\textbf{Appropriation flow.}] \ac{asnfmc} (Echelon I) allocates funds to Echelon II \acp{bso}; \acp{bso} distribute allotments and \acp{eob}. Echelon III field activities issue allowances and \acp{optar} to subordinate units at Echelon IV~\autocite{edo-3-1-5-field-activity-fm-2025}.
\end{description}
