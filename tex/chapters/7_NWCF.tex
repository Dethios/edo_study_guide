...
\begin{description}
  \item[\textbf{NOR.}] Current-year profit or loss based on revenue minus expenses~\autocite{edo-3-1-5-field-activity-fm-2025}.
  \item[\textbf{AOR.}] Cumulative gains and losses since inception; \ac{aor} is managed at Navy level and used to set rates~\autocite{edo-3-1-5-field-activity-fm-2025}.
...
\begin{description}
  \item[\textbf{Definition.}] Dollar value of reimbursable work ordered and funded but not yet completed at \ac{fy} end~\autocite{edo-3-1-5-field-activity-fm-2025}.
...
\begin{description}
  \item[\textbf{Specificity.}] Used to request routine or recurring day-to-day services within the Navy~\autocite{edo-3-1-5-field-activity-fm-2025}.
  \item[\textbf{Timing.}] Work must be completed before expiration of funds cited~\autocite{edo-3-1-5-field-activity-fm-2025}.
  \item[\textbf{Restrictions.}] Cannot be used to fund the basic mission of the performing activity~\autocite{edo-3-1-5-field-activity-fm-2025}.
\end{description}
