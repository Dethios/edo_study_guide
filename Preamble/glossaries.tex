...
% \RenewDocumentCommand{\ac}{s m}{%
%   \IfBooleanTF{#1}{%
%     \hyperlink{glo:#2}{\glsentryshort{#2}}%
%   }{%
%     \ifglsused{#2}{%
%       \hyperlink{glo:#2}{\glsentryshort{#2}}%
%     }{%
%       \hyperlink{glo:#2}{\glsentryfull{#2}}%
%       \glsadd{#2}%
%     }%
%   }%
% }%
...
% % Plural
% \RenewDocumentCommand{\acp}{s m}{%
%   \IfBooleanTF{#1}{%
%     \hyperlink{glo:#2}{\glsentryshortpl{#2}}%
%   }{%
%     \ifglsused{#2}{%
%       \hyperlink{glo:#2}{\glsentryshortpl{#2}}%
%     }{%
%       \hyperlink{glo:#2}{\glsentryfullpl{#2}}%
%       \glsadd{#2}%
%     }%
%   }%
% }%
...
\DeclareRobustCommand{\aclabel}[1]{\hyperlink{glo:#1}{\glsentryshort{#1}}}%
