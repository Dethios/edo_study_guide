...
\newcommand{\headingfont}{\firasanssemibold\color{AccentBlue}\Large}
\newcommand{\sectionfont}{\firasanssemibold\color{AccentBlue}\Large}
\newcommand{\firasb}{\firasanssemibold}
\newcommand{\merriweatherblack}{\rmfamily\bfseries}
\newcommand{\sourcesansprofont}{\sffamily}
\newcommand{\textsb}[1]{{\firasanssemibold #1}}

% Legacy inline hint/note wrappers routed through the moderntech styled boxes.
\newcommand{\hint}[1]{\Hint{#1}}
\newcommand{\note}[1]{\Note{#1}}
\newcommand{\tHint}{\textbf{\textcolor{AccentPurple}{Hint}}}
\newcommand{\tNote}{\textbf{\textcolor{AccentTeal}{Note}}}
\newcommand{\tSource}{\textbf{\textcolor{AccentGreen}{Source}}}
