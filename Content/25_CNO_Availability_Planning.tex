...
\begin{description}
  ...
  \item[\textbf{Planners.}] Shipyards, \acp{rmc}, and planning activities must sequence work, tooling, infrastructure, and Long-Lead Time Material (\ac{lltm}) so the schedule is executable.\autocite{edo-4-2-1-cno-availability-planning-2025}
...
\begin{enumerate}
  ...
  \item \textbf{Initial Planning (A-21).} Planning Activities (Carrier Planning Activity, Submarine Planning Activity, RMCs) reconcile the BAWP with Class Plan priorities and issue the Initial Availability Work Package (\ac{awp}).\autocite{edo-4-2-1-cno-availability-planning-2025}
  \item \textbf{Final Planning (A-12 to A-3).} Results of pre-availability tests (PATS/POTS), Departures from Specification (\ac{dfs}), Temporary Standing Orders (\ac{tso}), and new modernization approvals are adjudicated; the final AWP is issued no later than three months before A-0.\autocite{edo-4-2-1-cno-availability-planning-2025,OPNAVNOTE4700-24}
  \item \textbf{Contracting.} For surface private-yard availabilities, Multiple Award Contract, Multi-Order (\ac{macmo}) constructs increase competition and flexibility; public yards rely on Advanced Industrial Management (\ac{aim}) processes.\autocite{edo-4-2-1-cno-availability-planning-2025}
\end{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{Submarine Team One.} Led by PMS~392/SUBMEPP, integrates \ac{cnrmc}, NAVSEA 08/21, and public yards to sustain SSN/SSBN availabilities and implement NSS-SY initiatives.\autocite{edo-4-2-1-cno-availability-planning-2025}
