...
\begin{description}
	\item[\$100 million and above:] Implement the full ANSI/EIA-748 standard and ensure the contractorâ€™s system is formally validated by \ac{dcma}.
...
\begin{itemize}
	...
	\item \ac{dcma} leads \ac{evm} system acceptance, validation, and ongoing surveillance against ANSI/EIA-748 and the \ac{dod} \ac{evm} Implementation Guide; \ac{dcaa} supports with accounting system audits.
