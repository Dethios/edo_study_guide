...
\ac{lfte} assesses vulnerability (platform survivability) and lethality (munition effectiveness) using full-up systems, major subsystems, and surrogate articles subjected to operationally realistic threats, with instrumentation that captures battle damage, crew survivability, and cascading effects~\autocite{USC-10-2366,DoDI5000-89}. Covered systems (manned platforms, combat vehicles, munitions, and missile defense interceptors) must either execute a full-up \ac{lfte} program or obtain a waiver approved by \ac{secdef} and reported to Congress. Results inform design hardening, tactics (e.g., shot doctrine, avoidance envelopes), and survivability equipment upgrades, and they form a mandatory appendix within the \ac{dote} report before Full-Rate Production Decision Review (\ac{frpdr})~\autocite{DoDI5000-85}.
