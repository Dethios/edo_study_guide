...
\begin{description}
	\item[\textbf{\glsxtrshort{ja}.}] Documents the rationale for other-than-full-and-open competition, identifies the chosen statutory exception, and records approval by the appropriate official. Must be posted to \url{https://sam.gov} after award with required redactions~\autocite{FAR}.
	\item[\textbf{\glsxtrshort{df}.}] Formal determination that specific conditions are satisfied before taking an action (e.g., use of special contract types, multiyear contracting); states the findings that support the determination~\autocite{FAR}.
\end{description}
