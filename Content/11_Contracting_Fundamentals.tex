...
\begin{description}
	\item[\textbf{\ac{pm}}.] Accountable to the \ac{mda} for cost, schedule, and performance; integrates technical authority, requirements, and budget execution across the lifecycle.
