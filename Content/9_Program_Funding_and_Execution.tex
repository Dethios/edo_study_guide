...
\begin{enumerate}
  ...
  \item[] \srcCite{DoDFMR-Vol3,Treasury-GInvoicing}.
\end{enumerate}
...
\begin{center}
  \begin{talltblr}[
      ...
      remark{Source} = {\srcCite{DoDFMR-Vol3}}
    ]
    {
...
\begin{center}
  \begin{talltblr}[
      ...
      remark{Source} = {\srcCite{USC-3501,DFARS217-172,DoDFMR-Vol3}}
    ]
    {
      stretch=1.2, % Option B: no "fill the slack" stretching
      row{1} = {font=\bfseries\scshape\color{Modern}},
      colspec = {@{} Q[wd=.15\linewidth,cmd=\merriweatherblack\RaggedRight\small] P{.15\linewidth} W W @{}}
    }
    \toprule
...
\begin{center}\begin{talltblr}[
  ...
  ]
  {
    colspec = {F L},
    row{1}  = {font=\bfseries\scshape\color{Modern}},
    stretch = 1.2 % (Optional) avoid row â€œstretchingâ€; see notes below
  }
  \toprule
