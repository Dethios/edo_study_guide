...
\begin{description}
	...
	\item[\textbf{Regulation stack.}] \ac{far}~\textgreater~\ac{dfars}~\textgreater~\ac{nmcars} translates statute and policy into enforceable contracting rules; SECNAVINST~5000.2G tailors the ac{aaf} for ac{don} programs and makes \ac{asnrdanda} the \ac{sae}~\autocite{FAR,DFARS,SECNAV5000-2G}.
\end{description}
...
The \ac{aaf} can be visualized in \Fig{\ref{fig:aaf}}
