...
\begin{description}
	...
	\item[\textbf{Software Acquisition.}] Iterative \ac{devsecops} delivery, tailored documentation (Software Acquisition Strategy) and continuous Authority to Operate emphasis~\autocite{DoDI5000-02}.
