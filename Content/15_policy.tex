...
\begin{description}[style=nextline,labelsep=0.5em,font=\bfseries]
  ...
  \item[\textbf{Requirements--budget coupling.}] Key Operational Problems (\acp{kop}) and the \ac{rrab} ensure every joint problem statement is paired with funding guidance (including \ac{jar} taps) inside the same \ac{ppbe} cycle, eliminating the historical gap between validated requirements and appropriated dollars \autocite{secwar-jcids-reform-2025}.
