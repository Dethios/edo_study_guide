...
\begin{description}
  \item[\textbf{Modernization governance.}] The Navy Modernization Program (\ac{nmp}) integrates \ac{opnav} resource sponsors, \acp{peo}, Participating Resource Managers (\acp{parm}), Warfare Centers, and Fleet forces through the NMP Executive Steering Group and Sub-Class Modernization Coordinating Groups; the process is codified in SL720-AA-MAN-030, TS9090.310, and the JFMM.\autocite{SL720-AA-MAN-030,TS9090-310,COMFLTFORCOMINST4790-3}
  ...
  \item[\textbf{Execution agents.}] Alteration Installation Teams (\acp{ait}), Regional Maintenance and Modernization Coordination Offices (\ac{rmmco}), and \acp{supship} integrate modernization tasks into availabilities while Naval Supervising Activities verify that work followed the approved package.\autocite{SL720-AA-MAN-030,TS9090-310}
\end{description}
...
\begin{enumerate}
  ...
  \item \textbf{Install and certify.} AITs execute under a Memorandum of Agreement (MOA) that spells out safety, quality, and turnover requirements; completion data is entered into the Navy Data Environment (\ac{nde}) to update the authoritative configuration record.\autocite{SL720-AA-MAN-030,TS9090-310}
\end{enumerate}
...
\begin{description}
  ...
  \item[\textbf{MOA discipline.}] The MOA between the AIT, \ac{rmmco}, Naval Supervising Activity (\ac{nsa}), and Ship's Force defines boundary isolations, tag-out responsibilities, testing, and habitability; lessons learned from CANES and AWS installs show that unsigned MOAs invite production and safety conflicts.\autocite{TS9090-310,edo-4-1-2-navy-modernization-2025}
