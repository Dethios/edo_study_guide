...
\begin{enumerate}
	...
	\item \textbf{\ac{ouswc}/\ac{omb} Review}: \ac{dod} \ac{cfo} validates cash requirements, rate methodology, and capital plan, then seeks \ac{omb} alignment for the \ac{pb}~\autocite{DoDFMR-Vol3-Ch19}.
