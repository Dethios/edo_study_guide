...
\begin{description}
  ...
  \item[\textbf{\ac{som} Chapter 3.}] \ac{navsea} guidance for \ac{supship} on contract formation, modification, and surveillance\FlagBilletNote{RDML Jonathan J.\ Jett-Parmer leads \ac{supship} as NAVSEA Deputy Commander, with RDML Robert J.\ Dodson (USNR) as reserve deputy}\autocite{SOM-Ch3-2023}.
