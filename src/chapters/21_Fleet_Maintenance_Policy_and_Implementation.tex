...
\end{itemize}
% TODO: Build a single-glance table that links each controlling policy (\ac{opnavinst} 4700.7M, \ac{opnavnote} 4700, \ac{jfmm}, \ac{cbmp}) to the board-ready talking points (who owns it, what decisions it drives, and how to defend compliance).
