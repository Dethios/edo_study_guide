...
\begin{itemize}
  ...
  \item \ac{dcma} leads \ac{evm} system acceptance, validation, and ongoing surveillance against ANSI/EIA-748 and the \ac{dow} \ac{evm} Implementation Guide; \ac{dcaa} supports with accounting system audits.
  ...
  \item \ac{supship} can execute validation and surveillance responsibilities for shipbuilding programs on behalf of \ac{dcma}\FlagBilletNote{RDML Jonathan J.\ Jett-Parmer leads \ac{supship}; RDML Robert J.\ Dodson (USNR) is the reserve deputy}.
\end{itemize}
