...
\begin{description}
  ...
  \item[\textbf{Guidance stack.}] Primary references flow from Title 5, Office of Personnel Management guidance, Department of the Navy policy, and local agreements; document assumptions and keep counsel/\ac{hro} informed to avoid missteps~\autocite{edo-6-1-1-civpers-overview-2024}.
\end{description}
...
\subsection{Wrap-up cues}
\begin{description}
  \item[\textbf{Board-ready story.}] Be ready to explain who you call for classification, how you handled a performance/conduct issue, and how you engaged the union while protecting mission needs~\autocite{edo-6-1-6-civpers-wrap-up-2025}.
  \item[\textbf{Leadership tone.}] Invest in your civilians: connect them to Fleet mission context, coach frequently, and make recognition timely and specific~\autocite{edo-6-1-6-civpers-wrap-up-2025}.
\end{description}
