...
\begin{figure}[H]
  ...
  \includegraphics[width=\linewidth]{PPBE Timeline.png}
...
\begin{figure}[htbp]
  ...
  \caption[Platinum Card: \ac{ppbe} Planning Phase]{Platinum Card view of the \ac{ppbe} Planning phase (USDP-led strategic guidance path). \srcCite{edo-3-1-1-ppbe-2025}.}
...
\begin{longtblr}[%
    caption = {Key terms in \ac{ppbe}},%
    label   = {tab:ppbe_key_terms},%
    entry   = {Key \ac{ppbe} Terms},%
