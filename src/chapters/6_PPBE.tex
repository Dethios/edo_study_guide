...
\begin{description}
  \item[\textbf{\ac{cape}.}] \ac{cape} supports the Secretary and other \ac{dow} senior leaders through non-advocate, fact-based decision support on the size, shape, affordability, disposition, and readiness of the future joint force to achieve the National Defense Strategy. They do this by: (1) Supporting the Secretary in Analyzing and Adjusting the Defense Program with the Strategic Portfolio Review and by Leading the Department's Program Review; (2) Facilitating the Acquisition Process with Independent Cost Estimates and Guidance and sufficiency review for Analysis of Alternatives; and (3) Leading \ac{dow}'s Analytics and Cost Communities by Building the skills of the Department's analytical workforce and Providing deeper insights on \ac{dow} programs.
  ...
  \item[\textbf{\ac{n91}.}] Manages cross-domain mission integration and architecture; orchestrates \ac{pom} issue papers and mission engineering. \Warn{Office designators can shift; verify current subcodes week-of.}
\end{description}
