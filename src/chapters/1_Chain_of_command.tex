...
\begin{description}
  ...
  \item[\textbf{EDO-led billets (current).}] \ac{asnrdanda}'s \ac{pmildep} (\ac{vadm} Seiko Okano), \ac{comnavsea} (\ac{vadm} James P.\ Downey), \ac{ssp} (\ac{vadm} Johnny Wolfe Jr.), \ac{comnavwar} (\ac{radm} J.\ Kurt Rothenhaus), and the \acp{peo} for Ships (\ac{radm} Brian Metcalf), Aircraft Carriers (\ac{radm} Casey Moton), Attack Submarines (\ac{radm} Jonathan Rucker), and Unmanned and Small Combatants (\ac{rdml} Kevin R.\ Smith) are all led by \acp{edo}, anchoring \ac{ta} and acquisition governance in the community\FlagBilletNote{see Appendix~\ref{app:edo-flags} for the current flag billet roster}\autocite{navy-okano-2025,navy-downey-2025,navy-wolfe-2025,navy-rothenhaus-2025,navy-metcalf-2025,navy-moton-2025,navy-rucker-2025,navy-smith-2024}.
\end{description}
