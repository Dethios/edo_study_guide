...
\begin{description}[style=nextline,labelsep=0.5em,font=\bfseries]
  ...
  \item[\textbf{Outputs.}] Portfolio scorecards, capability roadmaps, trade memoranda, and data packages that substitute for the ICD/CDD/CPD sequence while still feeding Program Decision Memoranda, issue papers, and Acquisition Program Baselines \autocite{secwar-acq-transformation-2025}.
...
\begin{description}[style=nextline,labelsep=0.5em,font=\bfseries]
  ...
  \item[\textbf{Capability Trade Councils.}] Expect recurring requests to convene or support these councils with mission-thread data, digital models, and industrial-base options so that requirement, schedule, and cost trades are justified without defaulting to a JROC package \autocite{secwar-acq-transformation-2025}.
