...
% TODO: Insert DoW-wide test and evaluation organization graphic (\ac{osd} \ac{dote}, \ac{dasdte}, Service operational test agencies, warfare centers).
\begin{figure}
  \centering
  \fbox{\parbox{0.9\linewidth}{\centering To-do: Insert \ac{dow}-wide test and evaluation organization graphic (\ac{osd} \ac{dote}, \ac{dasdte}, Service operational test agencies, warfare centers).}}
  \caption{Notional \ac{dow} test and evaluation governance chain.}
\end{figure}
