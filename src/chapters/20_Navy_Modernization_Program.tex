...
\begin{enumerate}
  ...
  \item \textbf{Select availability.} Modernization Work Package Integration (WPI) events match each change to a specific \ac{cno} availability, Continuous Maintenance availability, or pier-side \ac{ait} window based on lead time material and platform readiness~\autocite{TS9090-310}.
...
\end{enumerate}
Failure to follow this sequence is why unauthorized equipment has been discovered during Board of Inspection and Survey (INSURV) events---a career ender for the responsible \ac{edo}.
