...
\begin{refsegment}
  ...
  \minibib
  \begin{description}
    \item[\textbf{\ac{peocvn}.}] Designs, builds, delivers, and sustains nuclear-powered aircraft carriers.\FlagBilletNote{RADM Casey J.\ Moton holds the \ac{peocvn} billet}
          \begin{description}
    ...
    \item[\textbf{\ac{peoiws}.}] Develops and sustains ship and submarine combat systems.
          \begin{description}
            ...
            \item[\textbf{IWS 12.0}.] \ac{nato} Seasparrow programs.
            \item[\textbf{IWS 80.0}.] Atalanta combat systems.
            \item[\textbf{IWS X}.] Integrated combat-system document center.
          \end{description}
    \item[\textbf{\ac{peoships}.}] Oversees surface combatant and amphibious ship construction and modernization.\FlagBilletNote{RADM Brian A.\ Metcalf serves as \ac{peoships}}
    \item[\textbf{\ac{peousc}.}] Manages littoral combat ships, frigates, expeditionary platforms, and unmanned surface/undersea portfolios.\FlagBilletNote{RDML Kevin R.\ Smith serves as \ac{peousc}}
    \item[\textbf{Team Submarines.}] Integrates strategic and attack submarine acquisition and sustainment.
          \begin{description}
            \item[\textbf{\ac{peossn}.}] Attack submarine programs.\FlagBilletNote{RADM Jonathan E.\ Rucker serves as \ac{peossn}}
                  \begin{description}
                    ...
                    \item[\textbf{PMS 394}.] Advanced undersea system's development.
