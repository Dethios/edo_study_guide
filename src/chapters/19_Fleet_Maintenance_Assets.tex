...
\begin{description}
  ...
  \item[\textbf{\ac{supship}.}] Supervisors of Shipbuilding administer new construction and conversion/modernization contracts as \acp{aco}, coordinate budget execution, and provide technical oversight for nuclear refueling overhauls (e.g., CVN \ac{rcoh})~\autocite{NAVSEAINST5450-145A,edo-4-1-1-fleet-maint-assets-2025}.
...
\begin{description}
  \item[\textbf{Flag oversight (EDO).}] \ac{cnrmc} is an EDO flag billet (RDML Dan L.\ Lannamann) reporting to \ac{comnavsea}; CNRMC sets standards and performance goals for all \acp{rmc} and aligns with TYCOM production priorities\autocite{navy-lannamann-2025,NAVSEAINST5450-145A}.
