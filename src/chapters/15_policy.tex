...
\begin{description}[style=nextline,labelsep=0.5em,font=\bfseries]
  \item[Major Capability Acquisition.]
        \textit{Entry.} Default when a validated \ac{icd}, PPBE affordability certification, and Title~10 \ac{mdap} thresholds are triggered; the \ac{dae} (\ac{uswas}) or delegated \ac{mdauthority} authorizes the Materiel Development Decision \autocite{DoDI5000-02,DoDI5000-85,USC-10-4201}.
