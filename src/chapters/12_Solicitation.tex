...
\begin{description}
  ...
  \item[\textbf{\ac{sba} programs.}] FAR Part~19~\autocite[Part~19]{FAR} implements 8(a), \ac{hubzone}, \ac{sdvosb}, and \ac{wosb} programs. The contracting officer must consider set-asides, sole-source thresholds, and subcontracting plans to meet \ac{don} goals.
\end{description}
