...
\begin{enumerate}
  ...
  \item \textbf{\ac{don} Approval Chain}: \ac{secnav} (delegated to ASN (FM\&C)) endorses the concept and forwards to \ac{ouswc} while coordinating with Navy Comptroller to align \ac{ppbe} exhibits~\autocite{DoDFMR-Vol3-Ch19}.
