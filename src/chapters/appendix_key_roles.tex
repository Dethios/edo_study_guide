...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  \item[\textbf{Department acquisition governance.}]
        Sources: \ac{secnavinst}~5400.15D; \ac{secnavinst}~5000.2G; DoDI~5000.85.
        \begin{itemize}
  ...
  \item[\textbf{Joint requirements governance.}]
        Sources~\autocite{jcids-manual-2021,secwar-acq-transformation-2025}.
        \begin{itemize}
          \item \textbf{\ac{jroc}:} Validates joint capability requirements, prioritizes gaps, and issues \ac{jrocm} direction that becomes binding input to Gate~2 and milestone documentation.
          \item \textbf{Joint Staff Gatekeeper/\ac{jcb}:} Controls the \ac{km-ds} queue, assigns Joint Staffing Designators, and routes most Navy submissions for \ac{jcb}-level validation to keep \ac{jroc} time focused on the highest-risk issues.
          \item \textbf{\acp{fcb}:} Chair certification working groups (Net-Ready, Force Protection, System Survivability), monitor \ac{dotmlpfp} implementation, and elevate Configuration Steering Board actions when requirement trades alter program baselines.
\item \textbf{\acp{pae} and \acp{ctctrade}:} The 2025 Acquisition Transformation Strategy empowers \acp{pae} to convene Capability Trade Councils that record requirement/cost/schedule trades in real time so \ac{peo} teams keep the \ac{das} synchronized with evolving demand signals.
  ...
  \item[\textbf{Combatant command sponsors.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{\ac{ccmd} staffs} conduct mission-thread analysis and architecture sprints with Fleets, labs, and industry to translate operational risk into measurable capability requirements before the Gatekeeper accepts a package.
  ...
  \item[\textbf{Joint Chiefs leadership.}]
        ...
        \begin{itemize}
          \item \textbf{\ac{cjcs}:} Principal military adviser to the President/\ac{secwar}, co-chairs the \ac{jroc}, and leads joint concept and readiness development that frames every Capability-Based Assessment.
  ...
  \item[\textbf{\ac{opnav} corporate leadership.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{\ac{opnav} resource sponsors (\ac{n8}, \ac{n82}, \ac{n9}, \ac{n91}):} Translate Fleet priorities into the \ac{pom}/\ac{fydp}, enforce two-pass/seven-gate rigor, and synchronize requirements, budgets, and \ac{peo} execution.
        \end{itemize}

  \item[\textbf{Acquisition decision authorities.}]
        Sources~\autocite{DoDD5000-01,DoDI5000-85,SECNAV5000-2G}.
        \begin{itemize}
\item \textbf{\ac{dae} / \ac{uswas}:} Issues acquisition policy, chairs the Defense Acquisition Board, and retains \ac{mdauthority} for \ac{acat}~ID/\ac{iam} programs unless delegated.
\item \textbf{\ac{sae}/\ac{asnrdanda}:} Assigns Navy \ac{mdauthority} for \ac{acat}~II and below, approves Service-tailored governance (e.g., two-pass/seven-gate), and charters \acp{peo}/\acp{drpm}.
  ...
  \item[\textbf{Program Authority chain.}]
        Sources: \ac{secnavinst}~5000.2G; DoDI~5000.85.
        \begin{itemize}
...
\item \textbf{\ac{dasdte}:} Designates Chief Developmental Testers and Lead Developmental Test and Evaluation Organizations for \ac{acat}~I programs, adjudicates test resource shortfalls, and co-chairs the Defense T\&E \ac{wipt}.
  ...
  \item[\textbf{Live-fire statutory leads.}]
        Sources~\autocite{USC-10-2366,DoDI5000-89}.
        \begin{itemize}
\item \textbf{\ac{dote} Live Fire Test Director:} Approves plans, monitors execution realism, and delivers the statutory lethality/vulnerability report to Congress.
          \item \textbf{Program Manager/Chief Engineer:} Funds threat-representative articles, integrates survivability design fixes, and aligns \ac{lfte} data with the Acquisition Program Baseline and sustainment plans.
  ...
  \item[\textbf{\ac{navsea} headquarters roles.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{\ac{sea}~05 Chief Engineer}: Chief \ac{ta}; issues warrants, certifies designs, and maintains technical standards.
  ...
  \item[\textbf{\ac{navwar} enterprise directorates.}]
...
\item \textbf{\ac{frd}-200 Installations}: Shore/afloat \ac{c4i} installation planning and cutover execution.
  ...
  \item[\textbf{Program Executive Offices (Navy portfolios).}]
        ...
        \begin{itemize}
          ...
          \item \textbf{\ac{peoiws}}: Develops and sustains ship/submarine combat systems; mission-aligned \ac{iws} directorates cover sensors, weapons, C2, and allied integration.
  ...
  \item[\textbf{Program Manager / \ac{ko} partnership.}]
        Sources: DoDI~5000.85; \ac{edo} Coursebook Module~3.2.1.
        \begin{itemize}
  ...
  \item[\textbf{Source selection governance.}]
        Sources: \ac{far} Parts~1, 5, and~15; \ac{navsea} Source Selection Guide (2022); \ac{edo} Coursebook Module~3.2.2.
        \begin{itemize}
  ...
  \item[\textbf{Fiscal control \& certification.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{Resource allocation chain}: \ac{ouswc} apportions to the Navy; \ac{opnav} (\ac{n82}/\ac{fmb}) allocates to \acp{bso}; \ac{syscom} comptrollers (e.g., \ac{sea}~01) issue suballocations to executing activities.
        \end{itemize}

\item[\textbf{\ac{ppbe} resource sponsors.}]
        Source: \ac{edo} Coursebook Module~3.1.1 (\ac{ppbe}, 2025 edition).
        \begin{itemize}
          ...
          \item \textbf{\ac{n8}}: Navy resource integrator (``checkbook''): builds a balanced Navy \ac{pom} across portfolios.
          ...
          \item \textbf{\ac{n83}}: Campaign analysis and future force design; anchors wargames and mission-level analytics that frame \ac{pom} decisions.
          \item \textbf{\ac{n84}}: Capability integration and resources; aligns \ac{peo} execution phasing, offsets, and two-pass/seven-gate products with budget marks.
          ...
          \item \textbf{\ac{n9}}: Requirements sponsor (``demand signal''): validates/advocates warfare requirements.
          \item \textbf{\ac{n91}}: Cross-domain integration; mission-level issue resolution (often labeled \ac*{n9i}).
