...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  ...
  \item[\textbf{NAVSEA headquarters roles.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{SEA~21 In-Service Ships/\ac{cnrmc}}: Leads surface-ship sustainment and modernization (\ac{pms}~321/326/339/421/443/451, SEA~21I, \ac{surfmepp}).
        \end{itemize}
  ...
  \item[\textbf{Fiscal control \& certification.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{Resource allocation chain}: \ac{ouswc} apportions to the Navy; \ac{opnav} (\ac{n82}/\ac{fmb}) allocates to \acp{bso}; \ac{syscom} comptrollers (e.g., SEA~01) issue suballocations to executing activities.
        \end{itemize}
