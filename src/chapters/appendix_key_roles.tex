...
\begin{description}[style=nextline, labelsep=0.5em, font=\bfseries]
  ...
  \item[\textbf{Joint requirements governance.}]
        ...
        \begin{itemize}
          \item \textbf{\ac{jroc}:} Validates joint capability requirements, prioritizes gaps, and issues JROCM direction that becomes binding input to Gate~2 and milestone documentation.
          ...
          \item \textbf{\acp{pae} and \acp{ctctrade}:} The 2025 Acquisition Transformation Strategy empowers PAEs to convene Capability Trade Councils that record requirement/cost/schedule trades in real time so \ac{peo} teams keep the \ac{das} synchronized with evolving demand signals.
        \end{itemize}
  ...
  \item[\textbf{Acquisition decision authorities.}]
        ...
        \begin{itemize}
          \item \textbf{\ac{dae} / \ac{uswas}:} Issues acquisition policy, chairs the Defense Acquisition Board, and retains \ac{mdauthority} for ACAT~ID/IAM programs unless delegated.
          \item \textbf{\ac{sae}/\ac{asnrdanda}:} Assigns Navy \ac{mdauthority} for ACAT~II and below, approves Service-tailored governance (e.g., two-pass/seven-gate), and charters \acp{peo}/\acp{drpm}.
          \item \textbf{Delegated \ac{mdauthority} (PEO/DRPM):} Signs Acquisition Decision Memoranda, manages Configuration Steering Boards, and keeps \ac{kpp}/\ac{apb} trades synchronized with requirements direction and statutory certifications.
        \end{itemize}
  ...
  \item[\textbf{Developmental test governance.}]
        ...
        \begin{itemize}
          \item \textbf{\ac{dasdte}:} Designates Chief Developmental Testers and Lead Developmental Test and Evaluation Organizations for ACAT~I programs, adjudicates test resource shortfalls, and co-chairs the Defense T\&E WIPT.
  ...
  \item[\textbf{Live-fire statutory leads.}]
        ...
        \begin{itemize}
          \item \textbf{DOT\&E Live Fire Test Director:} Approves plans, monitors execution realism, and delivers the statutory lethality/vulnerability report to Congress.
  ...
  \item[\textbf{Program Executive Offices (Navy portfolios).}]
        Sources: SECNAVINST~5400.15D; \ac{edo} Coursebook Modules~2.1.4 and~3.1.5.
        \begin{itemize}
  ...
  \item[\textbf{Contracting authority (\ac{ko} family).}]
        ...
        \begin{itemize}
          ...
          \item \textbf{\ac{sae}, \ac{asnrdanda}}: Signs \acp{df} for multiyear contracting, extraordinary relief, and other actions reserved to the Service Acquisition Executive under FAR Subparts~1.7 and~17.1.
        \end{itemize}
  ...
  \item[\textbf{Source selection governance.}]
        Sources: FAR Parts~1, 5, and~15; \ac{navsea} Source Selection Guide (2022); \ac{edo} Coursebook Module~3.2.2.
        \begin{itemize}
  ...
  \item[\textbf{Fiscal control \& certification.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{Resource allocation chain}: \ac{ouswc} apportions to the Navy; OPNAV (N82/FMB) allocates to \acp{bso}; \ac{syscom} comptrollers (e.g., SEA~01) issue suballocations to executing activities.
        \end{itemize}
