...
\item[\textbf{\ac{ppbe} resource sponsors.}]
        ...
        \begin{itemize}
          ...
          \item \textbf{\ac{n83}}: Fleet readiness integration and readiness reporting inputs that inform \ac{ppbe} trade space and joint requirements interfaces.
          \item \textbf{\ac{n84}}: Innovation, test and evaluation, and technology requirements focus areas that shape future investment priorities.
          ...
          \item \textbf{\ac{n89}}: Special programs division under \ac{n9}; sensitive portfolio oversight and governance integration.
