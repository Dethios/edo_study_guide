...
% DESCRIPTION: Constitutional foundations, key players, and regular-order timeline.
% =============================================================================
\begin{document}
...
\subsection{Committee markup and ``marks'' (congressional)}
\begin{description}
  \item[\textbf{What a mark is.}] A committee change (add/cut/plus-up, fence, reporting language) to the \ac{pb} request during subcommittee/full-committee markup and conference before the bill is enacted~\autocite{edo-3-1-2-congressional-enactment-2025}.
  \item[\textbf{When it matters most.}] The best opportunities to fix a problematic mark are before full committee and during conference/joint explanatory statement, where House/Senate differences are resolved~\autocite{edo-3-1-2-congressional-enactment-2025}.
  \item[\textbf{How programs respond.}] Program offices work issues through official channels (chain of command and Service \ac{ola}); provide fact-based impacts to cost/schedule/performance and executable alternatives. After enactment, relief typically requires use of formal reprogramming authorities (and thresholds) rather than informal advocacy~\autocite{edo-3-1-2-congressional-enactment-2025,DoDFMR-Vol3}.
  \item[\textbf{Board cue.}] Distinguish congressional marks (committee action) from internal marks/reclamas (budget formulation) and from reprogramming after enactment~\autocite{edo-3-1-1-ppbe-2025,edo-3-1-2-congressional-enactment-2025}.
\end{description}
...
\begin{description}
  \item[\textbf{Defense.}] Department of War appropriations.
  ...
  \item[\textbf{Commerce, Justice, Science.}] Departments of Commerce and Justice plus science agencies such as \ac{nasa} and the National Science Foundation.
...
\paragraph{Continuing resolution rules (board one-liner).}
\emph{No new starts}; rate/quantity changes generally constrained unless specified; execution limited by \ac{omb} apportionment, \ac{cr} anomalies, and any authorities Congress adds in the joint explanatory statement~\autocite{CRS-CR}.
