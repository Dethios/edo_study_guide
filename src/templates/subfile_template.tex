...
% TODO: [ ] Read X.X.X and assigned Codex actions
...
%   -
% 2. Include placeholders for figures at appropriate spots:
% 3. Update `acronyms.def` and `edo.bib` with new entries as needed.
% 4. The Coursebook is the first source document, but relevant sources from the Coursebook, DAU, and other resources should also be used.
